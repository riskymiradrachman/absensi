                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="container-fluid justify-content-end">
                            <?= form_open('admin/search_hdr') ?>
                            <div class="col-md-5">
                                <form class="navbar-form">
                                    <div class="input-group no-border">
                                        <input type="text" name="keyword" value="" class="form-control" placeholder="Masukkan tanggal (contoh : <?= date('d-m-Y'); ?>)">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <button class="btn btn-warning btn-sm" type="button">
                                                    ...
                                                    <a type="submit" href="<?= base_url('admin/excel_khdrn/' . $tanggal); ?>">Cetak Dokumen</a>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
