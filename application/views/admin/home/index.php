                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <button class="btn btn-warning btn-sm" type="button">
                          ...
                          <a type="submit" href="<?= base_url('admin/excel_pagi') ?>">Cetak Dokumen</a>
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-8 col-md-10 ml-auto">
                    <div class="row">
                      <div class="col-md-4">
                        <button class="btn btn-warning btn-sm" type="button">
                          <i class="fa fa-download"></i>
                          <a type="submit" href="<?= base_url('admin/excel_siang') ?>">Cetak Dokumen</a>
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-8 col-md-10 ml-auto">
                    <div class="row">
                      <div class="col-md-4">
                        <button class="btn btn-warning btn-sm" type="button">
                          <i class="fa fa-download"></i>
                          <a type="submit" href="<?= base_url('admin/excel_sore') ?>">Cetak Dokumen</a>
                        </button>
                      </div>
                    </div>
                  </div>
